...
module Linguist
  ...
  module BlobHelper
    ...
    # Return true or false
    def generated?
      if xcode_project_file? || generated_net_docfile? || generated_rdoc?
        true
    ...
    # Internal: Is this a generated documentation file of RDoc
    #
    # Requires Blob#data
    #
    # RDoc generates HTML files, so we need to check the content
    # for a signature of RDoc
    #
    # Returns true or false
    def generated_rdoc?
      return false unless lines.count > 3
      ...
      when ".html"
        # The last few lines say "Generated by RDoc"
        lines[-10..-1].each { |line| return true if line =~ /Generated by(.*)RDoc/ }
      
        # The first few lines have a title with RDoc
        lines[0..10].each { |line| return true if line =~ /<title>(.*)[RDoc Documentation]<\/title>/ }
      when ".js"
